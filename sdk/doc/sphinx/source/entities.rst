...
Overview
--------
An *Entity* is the term Socialize uses to describe any item of content within your app.  This could be anything from a news artical to a hamburger and 
simply provides a reference point from which your users
