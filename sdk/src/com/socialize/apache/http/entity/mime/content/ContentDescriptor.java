...
public interface ContentDescriptor {
	 ...
	 * <code>us-ascii</code>. For other types, when the charset parameter is
	 * missing this property will be null.
	 * </p>
	 * 
	 ...
	 *         be set to default <code>us-ascii</code>. For other types, when
