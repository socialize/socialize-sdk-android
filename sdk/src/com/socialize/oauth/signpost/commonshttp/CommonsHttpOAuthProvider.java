...
public class CommonsHttpOAuthProvider extends AbstractOAuthProvider {
    ...
    @Override
    protected com.socialize.oauth.signpost.http.HttpResponse sendRequest(HttpRequest request) throws Exception {
        HttpResponse response = httpClient.execute((HttpUriRequest) request.unwrap());
        return new HttpResponseAdapter(response);
    }

    @Override
    protected void closeConnection(HttpRequest request, com.socialize.oauth.signpost.http.HttpResponse response)
            throws Exception {
        if (response != null) {
